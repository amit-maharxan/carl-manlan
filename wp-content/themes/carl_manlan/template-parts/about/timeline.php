...
<section class="relative w-full">
    ...
    <div class="verticalTimeline grid auto-rows-[1fr] text-light text-center z-1 relative">
    <?php
    if( have_rows('timeline_data') ):
        while( have_rows('timeline_data') ) : the_row(); ?>
        <div class="timlineItem container grid grid-cols-[90px_1fr] lg:grid-cols-3 gap-8 lg:gap-4 place-content-center relative z-1">
