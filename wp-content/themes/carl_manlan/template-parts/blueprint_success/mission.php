<section class="relative w-full">
    ...
    <div
        ...
        <div
            ...
            <h2 class="text-3xl/relaxed uppercase z-1 relative font-medium mb-10 lg:mb-20">
            ...
            <div data-by=".word">
                ...
                <h2 class="text-2xl uppercase font-medium my-6 lg:my-16">
        ...
        <div class="img-wrapper flex relative group max-w-max lg:ml-auto mx-auto">
