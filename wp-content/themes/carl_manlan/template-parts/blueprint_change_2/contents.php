<section class="">
    <div class="relative w-full">
        ...
        <div class="container z-1 relative">
            <div class="grid py-20 md:grid-cols-2 text-light font-medium">
                ...
                <p class="font-poppins font-bold text-center" data-scrub-by=".word">
    ...
    <div class="container relative subscribe blogGrid bg-dark my-20" style="--grid-gap: 2.5rem">
        <div class="bgGrad absolute inset-0 bg-linear-to-b from-dark/30 via-dark/80 to-dark"></div>
    </div>
</section>
...
<script>
    ...
    $('.btn-filter').click(function(e) {
        ...
        var str = '&blueprint_id=' + blueprint_id + '&action=filter_blueprints_2';
